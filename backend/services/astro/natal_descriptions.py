...
- "short" — содержательное описание (4-5 предложений, ~80-120 слов): что эта планета в данном знаке означает для человека — характер, проявления в жизни, на что обратить внимание; дом упомяни только одним прикладным штрихом.
- "full" — полное описание (4-6 абзацев, ~450-650 слов) в стиле классических астрологических справочников: центр разбора — связка планета + знак; раскрой характер, мотивации, сильные стороны, потенциальные сложности, отношения, работу/дела и бытовые проявления. Дом используй только в финальном абзаце как персональное уточнение, не делай его главной темой.

Пиши тепло, конкретно, от второго лица («вы»). Без рекламы, markdown, заголовков и списков. Только обычные предложения и абзацы внутри строк.
...
- "short" (4-5 предложений, ~80-120 слов): что эта планета в данном знаке значит для человека — как проявляется в характере и в жизни, на что обратить внимание; дом упомяни только одним прикладным штрихом.
- "full" (4-6 абзацев, ~450-650 слов): развёрнутый справочный текст как в классическом описании «планета в знаке»: характер, мотивации, сильные стороны, уязвимости, отношения, работа/дела, привычки и бытовые проявления. Пиши цельно и подробно; дом добавь только в финальном абзаце как персональный акцент.
...
Вызови инструмент submit_entry с двумя полями:
- "short" (4-5 предложений, ~80-120 слов): какую сферу жизни описывает этот дом, как знак на куспиде её окрашивает, ключевые проявления.
- "full" (6-9 предложений, ~150-220 слов): тема дома подробнее, что говорит знак о подходе к этой сфере, как это видно в характере и поведении, сильные стороны и точки роста.
...
Вызови инструмент submit_entry с двумя полями:
- "short" (4-5 предложений, ~80-120 слов): как эти две темы взаимодействуют — что даёт человеку или с чем приходится работать.
- "full" (6-9 предложений, ~150-220 слов): как именно сочетаются эти две темы, гармония это или трение, какие сферы жизни затронуты, как проявляется в характере и поведении, сильные стороны и точки роста.
